...
class AdminProvider extends ChangeNotifier {
  ...
  List<AdminUser> _generateUsers() {
    ...
    return [
      AdminUser(id: '1', name: 'Harsha Bonthada', email: 'harsha@smarthome.ai', role: 'admin', status: 'active', lastLogin: DateTime.now().subtract(const Duration(minutes: 5)), createdAt: DateTime.now().subtract(const Duration(days: 365)), avatarColor: colors[0], devicesOwned: 25, actionsToday: 42),
      AdminUser(id: '2', name: 'Jane Smith', email: 'jane@smarthome.ai', role: 'editor', status: 'active', lastLogin: DateTime.now().subtract(const Duration(hours: 1)), createdAt: DateTime.now().subtract(const Duration(days: 280)), avatarColor: colors[1], devicesOwned: 12, actionsToday: 18),
      AdminUser(id: '3', name: 'John Doe', email: 'john@smarthome.ai', role: 'viewer', status: 'active', lastLogin: DateTime.now().subtract(const Duration(hours: 3)), createdAt: DateTime.now().subtract(const Duration(days: 200)), avatarColor: colors[2], devicesOwned: 8, actionsToday: 7),
      AdminUser(id: '4', name: 'Alice Johnson', email: 'alice@smarthome.ai', role: 'editor', status: 'active', lastLogin: DateTime.now().subtract(const Duration(hours: 6)), createdAt: DateTime.now().subtract(const Duration(days: 150)), avatarColor: colors[3], devicesOwned: 15, actionsToday: 23),
      AdminUser(id: '5', name: 'Bob Wilson', email: 'bob@smarthome.ai', role: 'viewer', status: 'suspended', lastLogin: DateTime.now().subtract(const Duration(days: 5)), createdAt: DateTime.now().subtract(const Duration(days: 120)), avatarColor: colors[4], devicesOwned: 3, actionsToday: 0),
      AdminUser(id: '6', name: 'Carol Davis', email: 'carol@smarthome.ai', role: 'editor', status: 'active', lastLogin: DateTime.now().subtract(const Duration(hours: 12)), createdAt: DateTime.now().subtract(const Duration(days: 90)), avatarColor: colors[5], devicesOwned: 10, actionsToday: 14),
      AdminUser(id: '7', name: 'David Lee', email: 'david@smarthome.ai', role: 'viewer', status: 'pending', lastLogin: DateTime.now().subtract(const Duration(days: 1)), createdAt: DateTime.now().subtract(const Duration(days: 7)), avatarColor: colors[6], devicesOwned: 0, actionsToday: 0),
      AdminUser(id: '8', name: 'Emma Brown', email: 'emma@smarthome.ai', role: 'viewer', status: 'active', lastLogin: DateTime.now().subtract(const Duration(hours: 2)), createdAt: DateTime.now().subtract(const Duration(days: 60)), avatarColor: colors[7], devicesOwned: 6, actionsToday: 9),
    ];
  }
