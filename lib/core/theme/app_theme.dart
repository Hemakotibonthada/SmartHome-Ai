...
class AppTheme {
  ...
  static const Color darkCard = Color(0xFF212745);
  static const Color darkCardLight = Color(0xFF2A3055);
  ...
  static const LinearGradient voltageGradient = LinearGradient(
